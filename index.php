    ...
    <div class="container">
        ...
        <div class="left-card">
            ...
            <div class="login">
                ...
                <p class="description">Login to get started in PractiEase AppDev</p>

                <form action="" method="post">
                    <input type="text" name="email" class="username" placeholder="Your email" required />
        ...
        <div class="right-card">
            <img class="right-img" src="./assets/Right pictre.jpg" alt="" />
        </div>
    </div>
</body>
